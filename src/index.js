...
export default class extends Component {
  ...
  render() {	
  	...
  	// console.log('state got updated',this.state);
    return (
    	<Fragment>
    	
		<form autoComplete="off" action="/action_page.php">
		  <div className="autocomplete" >
		    <input ref={this.inputRef} onInput={this.onInput} value = {this.state.currentActiveValue} onChange={this.onChange} onKeyDown={this.onKeyDown}  id="myInput" type="text" name="myCountry" placeholder="Country"/>
		  	<OptionsParent >
